...
(add-to-list 'load-path (concat user-emacs-directory "hindent/elisp"))
(require 'hindent)
(add-to-list 'load-path (concat user-emacs-directory "structured-haskell-mode/elisp"))
(require 'shm)
...
(custom-set-variables
 ...
 '(haskell-process-args-ghci
   (quote
    ("NIX_PATH=/Users/vladki/src/eris/deps:ops=/Users/vladki/src/ops" "with-aws" "stack" "ghci"))))
...
(define-key shm-map (kbd "<C-return>") 'haskell-simple-indent-newline-indent)
